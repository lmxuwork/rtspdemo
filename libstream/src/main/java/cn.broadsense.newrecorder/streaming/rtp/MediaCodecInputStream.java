...
//			mBufferInfo.presentationTimeUs = (System.currentTimeMillis() - mNextVideoTime) * 1000;
//            Log.e(TAG, "Get a H264 Frame:  buffer.size:" + mBufferInfo.size + "  buffer.pos:" + mBuffer.position() + "  Len:" + length + "  min:" + min);
