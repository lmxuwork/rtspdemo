 ...
 * RFC 3984.
 * <p>
 * H.264 com.deepwits.streaming over RTP.
 * <p>
...
public class H264Packetizer extends AbstractPacketizer implements Runnable {
    ...
    //public final static String TAG = "VideoStream";
    ...
    public void stop() {
        ...
        if (t != null) {
            Log.e(TAG, "H264Packetizer stop t:" + t.toString());
            try {
                is.close();
            } catch (IOException e) {
            }
    ...
    public void run() {
        ...
        if (is instanceof MediaCodecInputStream) {
            ...
            streamType = 0;
            socket.setCacheSize(200);//设置缓冲时间
        }
    ...
    private void send() throws IOException, InterruptedException {
        //Log.e(TAG, "H264Packetizer send  streamType:" + streamType);
