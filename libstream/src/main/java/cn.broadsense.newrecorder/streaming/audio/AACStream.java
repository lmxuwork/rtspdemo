...
package cn.broadsense.newrecorder.streaming.audio;
...
import cn.broadsense.newrecorder.streaming.rtp.AACADTSPacketizer;
import cn.broadsense.newrecorder.streaming.rtp.AACLATMPacketizer;
import cn.broadsense.newrecorder.streaming.rtp.MediaCodecInputStream;

/**
 * A class for com.deepwits.streaming AAC from the camera of an android device using RTP.
...
public class AACStream extends AudioStream {
	 ...
	 * Will fail if called when com.deepwits.streaming.
	 */
