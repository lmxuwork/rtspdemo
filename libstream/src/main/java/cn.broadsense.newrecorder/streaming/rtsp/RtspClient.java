...
public class RtspClient {
	...
	public RtspClient() {
		...
		new HandlerThread("cn.broadsense.newrecorder.streaming.RtspClient"){
			@Override
	...
	/**
	 * Connects to the RTSP server to publish the stream, and the effectively starts cn.broadsense.newrecorder.streaming.
