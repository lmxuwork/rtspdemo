...
package cn.broadsense.newrecorder.streaming.video;
...
import cn.broadsense.newrecorder.streaming.MediaStream;
import cn.broadsense.newrecorder.streaming.Stream;
...
import cn.broadsense.newrecorder.streaming.hw.NV21Convertor;
import cn.broadsense.newrecorder.streaming.rtp.MediaCodecInputStream;
...
public abstract class VideoStream extends MediaStream {
     ...
     * You should not call this method from the main thread if you are already com.deepwits.streaming.
     *
     * @throws IOException
    ...
    public synchronized void start() throws IllegalStateException, IOException {
        ...
        super.start();
        Log.e(TAG, "video stream is start");
    ...
    protected void encodeWithMediaRecorder() throws IOException, ConfNotSupportedException {
        ...
        try {
            ...
            // This one little trick makes com.deepwits.streaming feasible quiet simply: data from the camera
            ...
            //mMediaRecorder.setOutputFile("/sdcard/videostream.mp4");
    ...
    protected void encodeWithPatron() throws RuntimeException, IOException {
        Log.d(TAG, "encodeWithPatron().......mQuality.resX:" + mQuality.resX + " mQuality.resY:" + mQuality.resY);
//        if (DataSwitch.isSop) {
//            EncoderDebugger debugger = EncoderDebugger.debug(mSettings, mQuality.resX, mQuality.resY);
//            Log.e(TAG, "Video encoded using the Patron API   " + debugger.getEncoderColorFormat() + "   " + debugger.getEncoderName());
//            mMediaCodec = MediaCodec.createByCodecName(debugger.getEncoderName());
//        } else {
        mMediaCodec = MediaCodec.createByCodecName("OMX.MTK.VIDEO.ENCODER.AVC");//debugger.getEncoderName());OMX.MTK.VIDEO.ENCODER.AVC
//        }
        MediaFormat mediaFormat = MediaFormat.createVideoFormat("video/avc", mQuality.resX, mQuality.resY);
        mediaFormat.setInteger(MediaFormat.KEY_BIT_RATE, mQuality.bitrate);
        mediaFormat.setInteger(MediaFormat.KEY_FRAME_RATE, mQuality.framerate);
        mediaFormat.setInteger(MediaFormat.KEY_COLOR_FORMAT, MediaCodecInfo.CodecCapabilities.COLOR_FormatYUV420Planar);//YV12
        mediaFormat.setInteger(MediaFormat.KEY_I_FRAME_INTERVAL, 1);
        mMediaCodec.configure(mediaFormat, null, null, MediaCodec.CONFIGURE_FLAG_ENCODE);
        mMediaCodec.start();
        mCodecStarted = true;
