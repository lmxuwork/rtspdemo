...
import cn.broadsense.newrecorder.streaming.rtp.AbstractPacketizer;
import cn.broadsense.newrecorder.streaming.rtp.RtpSocket;
...
public abstract class MediaStream implements Stream {
    ...
    protected boolean mCodecStarted = false;
    ...
    /**
     * Sets the com.deepwits.streaming method that will be used.
     * <p/>
    ...
    /**
     * Returns the com.deepwits.streaming method in use, call this after
    ...
    /**
     * Indicates if the {@link MediaStream} is com.deepwits.streaming.
     *
     * @return A boolean indicating if the {@link MediaStream} is com.deepwits.streaming
     */
    ...
    public synchronized void configure() throws IllegalStateException, IOException {
        if (mStreaming)
            throw new IllegalStateException("Can't be called while com.deepwits.streaming.");
        if (mPacketizer != null) {
            mPacketizer.setDestination(mDestination, mRtpPort, mRtcpPort);
    ...
    protected void createSockets() throws IOException {
        ...
        if (sPipeApi == PIPE_API_LS) {
            ...
            final String LOCAL_ADDR = "net.majorkernelpanic.com.deepwits.streaming-";
            ...
            mReceiver.setReceiveBufferSize(600000);
            mReceiver.setSoTimeout(3000);
            mSender = mLss.accept();
            mSender.setSendBufferSize(600000);
