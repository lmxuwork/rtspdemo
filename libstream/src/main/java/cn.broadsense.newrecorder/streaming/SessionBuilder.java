...
import cn.broadsense.newrecorder.streaming.audio.AMRNBStream;
...
import cn.broadsense.newrecorder.streaming.video.H263Stream;
...
public class SessionBuilder {
    ...
    /**
     * Returns a reference to the {@link .streaming.SessionBuilder}.
     *
     * @return The reference to the {@link .streaming.SessionBuilder}
     */
    ...
    public Session build() {
        ...
        session.setCameraPosition(mCameraPosition);
        ...
        switch (mAudioEncoder) {
            case AUDIO_AAC:
                ...
                stream.setStreamingMethod(MediaStream.MODE_MEDIACODEC_API);
        ...
        switch (mVideoEncoder) {
            ...
            case VIDEO_H264:
                ...
                stream.setStreamingMethod(MediaStream.MODE_PATRON_RECORD);
                if (mContext != null)
                    stream.setPreferences(PreferenceManager.getDefaultSharedPreferences(mContext));
    ...
    public SessionBuilder setCameraPosition(int position) {
